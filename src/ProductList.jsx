...
function ProductList() {
    ...
    // Access cart state to calculate total quantity
    const cart = useSelector(state => state.cart.items);  // Get the items in the cart
    ...
    const handleAddToCart = (plant) => {
        ...
        // Dispatch the action to add the plant to the cart
        dispatch(addItem({ 
            name: plant.name, 
            image: plant.image, 
            cost: plantCost 
    ...
    const handleCartClick = (e) => {
        e.preventDefault();
        setShowCart(true); // Show cart when the cart icon is clicked
    };

    const handlePlantsClick = (e) => {
        e.preventDefault();
        setShowPlants(true); // Show plants when "Plants" is clicked
